...
if __name__ == '__main__':
	res_path_base = "/bcb/agusevlab/awang/ase_finemap_results/KIRC_RNASEQ/1cv_tumor_{0}/{1}"

	# SCARB1
	res_paths = [res_path_base.format(i, "ENSG00000073060") for i in ["all", "200", "100", "50", "10"]]
	...
	# DPF3
	res_paths = [res_path_base.format(i, "ENSG00000205683") for i in ["all", "200", "100", "50", "10"]]
	sample_sizes = [524, 200, 100, 50, 10]
	gene_name = "DPF3"
	out_dir = "/bcb/agusevlab/awang/ase_finemap_results/KIRC_RNASEQ/manhattan"
	model_flavors = set(["indep", "eqtl"])
	...
	# GRAMD4
	res_paths = [res_path_base.format(i, "ENSG00000075240") for i in ["all", "200", "100", "50", "10"]]
	sample_sizes = [524, 200, 100, 50, 10]
	gene_name = "GRAMD4"
	out_dir = "/bcb/agusevlab/awang/ase_finemap_results/KIRC_RNASEQ/manhattan"
	model_flavors = set(["indep", "eqtl"])
